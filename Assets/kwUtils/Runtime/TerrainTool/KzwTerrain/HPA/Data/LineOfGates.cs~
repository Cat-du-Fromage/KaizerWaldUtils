...
namespace KWUtils
{
    ...
    public struct GateCluster
    {
        ...
        public GateCluster(int indexCluster, int2 numSpaceHV, int2 numChunkXY, Memory<Gate> gateSlice, Memory<bool4> side1, Memory<bool4> side2)
        {
            IsClosed = false;
            GateSlice = gateSlice;
        ...
        public struct JUpdateImmediate : IJob
        {
            ...
            private void UpdateGateState(bool newValue)
            {
                ...
                /*
                    ...
                    {
                        // Si orientation horizontal : chunk1 = 1(Right); chunk2 = 3(left)
                        ChunkSide1[0] = new bool4(ChunkSide1[0].x, newValue, ChunkSide1[0].zw);
                        ChunkSide2[0] = new bool4(ChunkSide2[0].xyz, newValue);
                    }
                    else
                    {
                        // Si Orientation Vertical : chunk1 = 2(bottom); chunk2 = 0(top)
                        ChunkSide1[0] = new bool4(ChunkSide1[0].xy,newValue,ChunkSide1[0].w);
                        ChunkSide2[0] = new bool4(newValue,ChunkSide2[0].yzw);
                    }
*/
            }
        }
